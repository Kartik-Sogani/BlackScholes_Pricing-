...
def main():
    ...
    S = st.sidebar.number_input("Current Asset Price (S)", value=200.0, min_value=0.01)
    K = st.sidebar.number_input("Strike Price (K)", value=195.0, min_value=0.01)
